...
def get_config():
    ...
    Pretrained parameters:
        ...
        --jump_start_model_dir <str>
            by default None. set the path to pretrained model used to jump start the learning process.
        --jump_start_model_pool_dir <str>
            by default None. set the path to pretrained models used to jump start the learning process.

        --closest_attack
            by default, chose weakest enemy. If set`, start choosing closest enemy.
        --multi_player
            by default, play against static AI. If set`, start multi player game..
        --eval_test
            for evaluation
        --arena
            arena type game
    ...
    parser.add_argument("--user_name", type=str, default='as995s',help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    # parser.add_argument("--jump_start_model_dir", type=str, default='/home/ayesha/projects/researchSpring2022/mappo/onpolicy/scripts', help="by default None. set the path to pretrained model used to jumpstart the learning process.")
    parser.add_argument("--jump_start_model_dir", type=str, default=None, help="by default None. set the path to pretrained model used to jumpstart the learning process.")
    parser.add_argument("--jump_start_model_pool_dir", type=str, default=None, help="by default None. set the path to pretrained model pool used to jumpstart the learning process.")

    parser.add_argument("--closest_attack", action='store_true', default=False, help="by default, chose weakest enemy. If set`, start choosing closest enemy.")
    parser.add_argument("--arena", action='store_true', default=False, help="by default sigle player, arena type playing.")
    parser.add_argument("--multi_player", action='store_true', default=False, help="by default, play against static AI. If set`, start multi player game.")
