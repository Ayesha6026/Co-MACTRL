...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.eval_map_name = args.eval_map_name
        ...
        map_params = get_map_params(self.eval_map_name)
    ...
    def _launch(self):
        ...
        _map = maps.get(self.eval_map_name)
        self._seed += 1
    ...
    def step(self, actions):
        ...
        try:
            ...
            return local_obs, None, global_state, [[0]]*self.n_agents, dones, infos, available_actions, None
        ...
        return local_obs, None, global_state, rewards, dones, infos, available_actions, None
